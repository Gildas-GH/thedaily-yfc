...
<?php if ($hasImages): ?>
  <?php if (count($images) == 1): ?>
    <?php if (metadata('item', 'has files')):
      $fileUrl = $images[0]->getWebPath('original'); ?>
      <div class="item-img-show">
          <a href="<?php echo $fileUrl; ?>"><?php echo file_image('thumbnail', array(), $images[0]); ?></a>
      </div>
    <?php endif; ?>
  <?php else: ?>
...
<div id="other-media" class="element">
    ...
    <div class="element-text"><a href="<?php echo $fileUrl; ?>"><?php echo metadata('item', array('Dublin Core', 'Title')); ?></a> - <?php echo $nonImage->mime_type; ?></div>
    <?php endforeach; ?>
</div>
<?php endif; ?>
